        ...
        <table className="table w-full border rounded-lg">
          ...
          <tbody>
            ...
            <tr className="hover:bg-gray-100 dark:hover:bg-gray-600">
              ...
              <td className="px-4 py-2 text-center">Midterm</td>
              <td className="px-4 py-2 text-center">2025-02-10</td>
              ...
              <td className="px-4 py-2 text-center">
                <button className="btn btn-sm bg-btnbg text-white mr-2 borded-none dark:bg-secondary dark:hover:bg-btnbg">Edit</button>
