...
class TeacherMiddleware
{
     ...
     * and checks if the user's role is "teacher." If yes, the request proceeds;
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (!isset($claims->user_role) || strtolower($claims->user_role) !== 'teacher') {
            return response()->json(['error' => 'Unauthorized: Teachers only'], 401);
        }
